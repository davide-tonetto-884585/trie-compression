...
\usepackage{fontenc} % Font encoding, T1 = it
\usepackage{lmodern}
...
\usepackage{titlesec}
\usepackage{float}
\usepackage[font=small, skip=5pt, justification=centerlast]{caption} % Spazio tra la caption e l'immagine
...
\usepackage{xspace}
\usepackage{enumitem}
\setlist[itemize]{leftmargin=25pt}
\setlist[enumerate]{leftmargin=25pt}
...
\
\newpage
\input{dedica.tex} % PAGINA ABSTRACT
\newpage
\
\newpage
...
\
\newpage
\chapter{Preliminary Concepts} \label{chp:preliminary}
...
% \input{Capitoli/XBWT/Implementation.tex} % moved to chp Eperiments
% \input{Capitoli/XBWT/ExperimentsAndConclusions.tex} % moved to chp Eperiments
...
\
\newpage
\input{Capitoli/conclusionsAndFutureWork.tex}
\newpage
\
% ----------------------
% ---- BIBLIOGRAPHY ----
