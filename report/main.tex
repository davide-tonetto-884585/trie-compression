...
\newcommand{\equivsetmath}{$\equivset$\xspace}
\newcommand{\equivsetfunc}[1]{$\equivset(#1)$\xspace}

\newcommand{\sourcesetbase}{\mathcal{S}}
\newcommand{\sourceset}{$\sourcesetbase$\xspace}

\newcommand{\destsetbase}{\mathcal{D}}
\newcommand{\destset}{$\destsetbase$\xspace}

\newcommand{\treesetbase}[1]{\mathcal{T}_{#1}}
\newcommand{\treeset}[1]{$\treesetbase{#1}$\xspace}
...
\newtcolorbox[use counter=example]{examplebox}{%
    ...
    title={\exampletext~\thetcbcounter: #1},% use \thetcbcounter to access the example counter text
