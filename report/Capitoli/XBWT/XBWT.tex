...
\begin{definition}
    ...
    \begin{itemize}
        ...
        \item $\pi(u)$: the string obtained by concatenating the labels of the nodes on the upward path from $u$'s parent to the root of $T$. Formally, we define $\pi(u)$ recursively as:
        \begin{align*}
            \pi(u) = \begin{cases}
