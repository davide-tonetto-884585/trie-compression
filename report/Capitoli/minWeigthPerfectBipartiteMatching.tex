...
\begin{example}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{Example of (a) a non-minimum weight perfect matching and (b) a minimum weight perfect matching in a bipartite graph. Double edges have weight 2 while single edges 1. The edges in a matching are highlighted in red.}
