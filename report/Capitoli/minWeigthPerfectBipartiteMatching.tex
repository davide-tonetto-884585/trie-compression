...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance={15mm}, thick, auto=center, main/.style = {draw, circle}] 
        \node[main] (2s) {$u_1$}; 
        \node[main] (1s) [below of=2s] {$u_2$};
        \node[main] (4s) [below of=1s] {$u_3$};
        \node[main] (3d) [right=2cm of 2s] {$u_4$};
        \node[main] (2d) [below of=3d] {$u_5$}; 
        \node[main] (1d) [below of=2d] {$u_6$};
        \node[main] (4d) [below of=1d] {$u_7$};
        \draw[->] (1s) -- (3d);
        \draw[->] (1s) -- (2d);
        \draw[->] (4s) -- (3d);
        \draw[->] (2s) -- (4d);
...
\begin{example}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{Examples of (a) a non-matching, (b) a non-perfect matching, and (c) a perfect matching in a bipartite graph. The edges in the set $M$ are highlighted in red.}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \begin{tikzpicture}[node distance={15mm}, thick, auto=center, main/.style = {draw, circle}]
                ...
                \draw[->, red] (u3) -- (v3);
            \end{tikzpicture}
            \caption{Min. weight perfect matching.}
            \label{fig:mwpbm_perfect}
        \end{subfigure}
        \caption{Example of (a) a non-minimum weight perfect matching and (b) a minimum weight perfect matching in a bipartite graph. Double edges have weight 2, while single edges have weight 1. The edges in a matching are highlighted in red.}
