...
\begin{example}[Vertices] \label{ex:reduction_vertices}
    ...
    % 0 3 4 2 5 8 9 1 6 7 10
    \[
        a \prec h \prec i \prec d \prec e \prec l \prec m \prec b \prec c \prec f \prec g
    \]
    ...
    \begin{figure}[H]
        ...
        \end{tikzpicture}
        \caption{Tree DAWG of \cref{fig:example_dawg}. Each node is labeled with its equivalence class.}
