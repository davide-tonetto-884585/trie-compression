...
The co--lex order can be extended to the set of states of an automaton.
...
\begin{definition}[co--lexicographic order on an NFA,~\cite{cotumaccio2023co}]
...
\begin{definition}[Width of an NFA,~\cite{cotumaccio2023co}]
...
\begin{example}[\cite{manziniRationalConstructionWheeler2024}]
    ...
    \begin{tikzpicture}[
        ...
        \node[state, initial, initial text=] (start) at (0,0) {$u_0$};
        
        \node[state] (w1_1) at (1.5,1.3) {$u_1$};
        \node[state] (w1_2) at (1.5,-1.3) {$u_2$};
        \node[state] (q1) at (3,0) {$u_3$};
        %\node at (3, -0.7) {$q_1$};
        ...
        \node[state] (w2_1) at (4.5,1.3) {$u_4$};
        \node[state] (w2_2) at (4.5,-1.3) {$u_5$};
        \node[state] (q2) at (6,0) {$u_6$};
        %\node at (6, -0.7) {$q_2$};
        ...
        \node[state] (qn) at (9,0) {$u_{t-3}$};
        \node[state] (wn_1) at (10.5,1.3) {$u_{t-2}$};
        \node[state] (wn_2) at (10.5,-1.3) {$u_{t-1}$};
        \node[state, accepting] (t) at (12,0) {$u_t$};
        %\node at (9, -0.7) {$q_{n-1}$};
        %\node at (12, -0.7) {$q_n$};
...
\begin{theorem}[\cite{cotumaccio2021indexing}]
    \label{thm:indexing}
